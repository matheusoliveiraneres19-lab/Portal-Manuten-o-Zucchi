...
/** Modal premium centralizado (preto/grafite/dourado), usado na importação do PC-Factory. */
export function PcFactoryModalShell({ open, title, subtitle, onClose, children }: PcFactoryModalShellProps) {
  useEffect(() => {
    if (!open) {
      return;
    }
