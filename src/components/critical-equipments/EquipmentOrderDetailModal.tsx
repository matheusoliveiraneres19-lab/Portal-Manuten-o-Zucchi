      ...
      {order ? (
        ...
        >
          ...
          <m.div
            ...
            className="relative flex max-h-[88vh] w-full max-w-2xl flex-col overflow-hidden rounded-lg border border-gold/30 bg-ink text-champagne shadow-[0_0_60px_rgba(0,0,0,0.7)]"
          >
