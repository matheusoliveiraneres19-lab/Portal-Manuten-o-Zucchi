...
import { Droplets, RefreshCw, ServerCrash, Upload } from "lucide-react";
...
export function LubricantEmptyState({ onImport, unavailable = false }: LubricantEmptyStateProps) {
  return (
    <div className="relative overflow-hidden rounded-card border border-gold/20 bg-ink p-10 text-center shadow-premium">
      ...
      <div className="relative z-10 mx-auto flex max-w-xl flex-col items-center gap-4">
        ...
        <h2 className="font-serif text-2xl text-white">
          {unavailable ? "Dados de lubrificantes indisponíveis" : "Nenhuma movimentação de lubrificante ainda"}
        </h2>
        {unavailable ? (
          <p className="max-w-md text-sm leading-relaxed text-zinc-300">
            Não foi possível consultar o banco de dados agora. Os dados importados não foram perdidos — atualize a
