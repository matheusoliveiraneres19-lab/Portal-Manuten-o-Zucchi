...
/** Modal premium centralizado, reutilizado por aplicação/ficha técnica/importação. */
export function LubricantModalShell({ open, title, subtitle, onClose, children }: LubricantModalShellProps) {
  useEffect(() => {
    if (!open) {
      return;
    }
...
export const fieldLabelClass = "mb-1 block text-[11px] font-semibold uppercase tracking-wide text-zinc-400";
export const fieldInputClass =
  "h-10 w-full rounded-lg border border-gold/15 bg-black/35 px-3 text-sm text-zinc-100 outline-none transition focus:border-gold/55 focus:bg-black/50";
